...
document.addEventListener('DOMContentLoaded', () => {
    ...
    gsap.set('.nav-resume', { opacity: 0, x: 20 });
    ...
    const button = document.querySelector('.hero_content button');
...
window.addEventListener('load', function() {
    setTimeout(function() {
        document.querySelectorAll('nav, .hero_content h1, .hero_content p, .hero_content button, .nav-links li, .nav-resume').forEach(function(el) {
